...
-- Plans defined by admin (hetanshtechnologie@gmail.com)
...
CREATE POLICY "admin manage plans" ON qna_plans FOR ALL USING (auth.jwt() ->> 'email' = 'hetanshtechnologie@gmail.com');
